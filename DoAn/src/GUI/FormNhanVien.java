...
public class FormNhanVien {
	...
	private JTextField txtfTenNhanVien,txtfSDT,txtfDiaChi,txtfTenDangNhap;
	private JPasswordField pwfMatKhau;
	JSpinner spinnerLoaiNhanVien;
	private JTextField txtfMaNhanVien;
	...
	public void initComponents() {
		...
		ImageIcon iconQLNV = new ImageIcon(this.getClass().getResource("/5. activeuser.png"));
		...
		pwfMatKhau.setBounds(650, 174, 198, 29);
		pnMain.add(pwfMatKhau);
		...
		btnThem.setBounds(180, 303, 172, 35);
		...
		btnXoa.setBounds(410, 303, 172, 35);
		...
		btnSua.setBounds(640, 303, 172, 35);
	...
	private void BindingNhanVien() {
		try {
			...
			pwfMatKhau.setText(table.getModel().getValueAt(row, 5).toString());
	...
	private void addNhanVien() {
		...
		pwfMatKhau.getText().trim().equals("") ||
		...
		NV.setNhanVien_Password(pwfMatKhau.getText());
