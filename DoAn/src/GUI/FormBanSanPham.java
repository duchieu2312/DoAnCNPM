...
public class FormBanSanPham {
	...
	private void AddHoaDon() {
		...
		if (txtfMaKhachHang.getText().trim().equals("") ||
			txtfMaNhanVien.getText().trim().equals("")) 
		{
			...
			HoaDon.setHoaDonBan_IDKH(Integer.parseInt(txtfMaKhachHang.getText()));
			HoaDon.setHoaDonBan_IDNV(Integer.parseInt(txtfMaNhanVien.getText()));
			HoaDon.setHoaDonBan_DateHD(Date.valueOf(LocalDate.now()));
			JOptionPane.showMessageDialog(null,HoaDonBanBLL.addHoaDon(HoaDon));
		}
		} catch (Exception e) {
			System.out.println(e);
		}
	...
	private void DeleteHoaDon() {
		try{
			HoaDonBanBLL HoaDonBanBLL = new HoaDonBanBLL();
			JOptionPane.showMessageDialog(null,HoaDonBanBLL.deleteHoaDon());
